...
def save_file(driver):
    ...
    WebDriverWait(driver, timeout=10).until(
        ex.presence_of_element_located((By.CLASS_NAME, '_93444fe79c--main--PpO9F._93444fe79c--light--fV8h9')))
...
def main():
    ...
    # 200 обьявлений, не включена лоджия
    url1 = 'https://krasnoyarsk.cian.ru/cat.php?deal_type=sale&' \
           'engine_version=2&' \
           'floornl=1&' \
           ...
           'room2=1&' \
           'room3=1'
    # 600+ c лоджией и балконом, новостройки и вторичка
